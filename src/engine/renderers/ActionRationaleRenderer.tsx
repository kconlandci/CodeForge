...
const COLOR_MAP: Record<string, { selected: string; base: string }> = {
  ...
  orange: { selected: "bg-rose-500/20 border-rose-500 text-rose-300", base: "bg-slate-800 border-slate-700 text-slate-300 hover:border-slate-500" },
    ...
    <div className="space-y-4">
      ...
      {phase === "active" && (
        <button
          ...
          className="w-full py-3 rounded-xl bg-rose-500 hover:bg-rose-600 disabled:bg-slate-700 disabled:text-slate-500 text-white font-semibold transition-colors"
        >
          Submit Answer
        </button>
      )}
