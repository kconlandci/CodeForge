        ...
        <div className="max-w-lg mx-auto pt-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-rose-500/20 flex items-center justify-center">
              <Code className="text-rose-400" size={24} />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white">{manifest.title}</h1>
              <div className="flex gap-2 mt-1">
                <span className="px-2 py-0.5 rounded text-xs font-medium bg-sky-500/20 text-sky-300">
                  {manifest.tier}
                </span>
          ...
          <div className="bg-slate-800 rounded-xl p-4 mb-6">
            ...
            <ul className="space-y-2">
              {manifest.learningObjectives.map((objective, index) => (
                ...
                >
                  <Target size={14} className="text-rose-400 mt-0.5 shrink-0" />
                  {objective}
                </li>
              ))}
            </ul>
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-rose-500 hover:bg-rose-600 text-white font-semibold text-lg transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="bg-slate-800 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-2 mb-2">
              <Lightbulb size={16} className="text-rose-400" />
          ...
          <div className="bg-slate-800 rounded-xl p-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {manifest.toolRelevance.map((tool, index) => (
                <span
                  key={index}
                  className="px-2 py-1 rounded bg-slate-700 text-xs text-slate-300"
                >
                  {tool}
                </span>
              ))}
      ...
      <div className="sticky top-0 z-10 bg-slate-900/95 backdrop-blur border-b border-slate-800 px-4 py-3">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-rose-400">{score}</span>
        ...
        <div className="sticky bottom-0 z-10 bg-slate-900/95 backdrop-blur border-t border-slate-800 px-4 py-3">
          <div className="max-w-lg mx-auto">
            <button
              ...
              className="w-full py-3 rounded-xl bg-rose-500 hover:bg-rose-600 text-white font-semibold transition-colors flex items-center justify-center gap-2"
            >
